  ...
  case EVT_VENDOR:
    {
      ...
      case EVT_BLUE_GATT_READ_PERMIT_REQ:
        ...
        break;
#if 0   
      case EVT_BLUE_GATT_ATTRIBUTE_MODIFIED:  // if "GATT_NOTIFY_ATTRIBUTE_WRITE"
        {
      ...
      case EVT_BLUE_GATT_WRITE_PERMIT_REQ:    // if "GATT_NOTIFY_WRITE_REQ_AND_WAIT_FOR_APPL_RESP"
        {
          evt_gatt_write_permit_req *pr = (void *)blue_evt->data;
          Write_Request_CB(pr);
        }
